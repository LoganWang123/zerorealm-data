"""Runtime safety net while the remote repository still has a legacy workflow.

These tests must stay strict. Dual-shape workflow YAML tests must not skip them.
"""
